...
def get_wikipedia_pages():
    with open("../newWikiTXTParts/wikiPart1.txt", "r") as fileR: #HERE 1 2 3 4 5 6 7 8 
    ...
    with open("../newJsonParts/Species_data1.json", "w", encoding="utf-8") as json_file: #HERE 1 2 3 4 5 6 7 8 
