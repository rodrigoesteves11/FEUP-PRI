...
def solr_combined_query(endpoint, collection, query_text, embedding):
    ...
    data = {
        ...
        "defType": "edismax",
        "qf": "introduction^5 sections^6",
        "pf": "introduction^3 sections^2",
        "ps": 5,
        "qs": 3,
        "tie": 0.4,
        "bq": "sections:invasive^2 introduction:invasive^4",
        "rows": 300,
...
def main():
    ...
    query_text = "(species negative impact) AND invasive"
    user_query = "Invasive species with negative impact"
